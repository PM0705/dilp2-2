                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="textfield">
                                    ...
                                    <div>
                                        <p>フリガナ</p>
                                        <input type="text" class="form-control last_name" name="last_name" pattern="^[\u30A0-\u30FF]+$" placeholder="ディーアイワークス" title="全角カタカナのみでご入力ください" id="last_name" maxlength="10" value="<?= getPostValue('last_name') ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="textfield">
                                    ...
                                    <div>
                                        <p>フリガナ</p>
                                        <input type="text" class="form-control last_name_kana" placeholder="ダイバハナコ" pattern="^[\u30A0-\u30FF]+$" title="全角カタカナのみでご入力ください" name="last_name_kana" id="last_name_kana" maxlength="10" value="<?= getPostValue('last_name_kana') ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="textfield">
                                    <input type="text" class="form-control mail" placeholder="example@works.jp" name="mail" id="mail" maxlength="100" size="45" pattern="^[a-zA-Z0-9\-]+@[a-zA-Z0-9\-]+\.[a-zA-Z0-9\-]+$" value="<?= getPostValue('mail') ?>">
                                </div>
                            ...
                            <td>
                                <div class="textfield workday">
                                    <select name="workday" required class="form-select workday" id="workday">
                                        <option selected value="無料お見積り">無料お見積り</option>
